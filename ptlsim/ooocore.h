...
#define BIG_ROB
  ...
  // Dispatch
  //
  const int DISPATCH_WIDTH = 8;

  //
  // Writeback
  //
  const int WRITEBACK_WIDTH = 8;

  //
  // Commit
  //
  const int COMMIT_WIDTH = 8;
...
#else // single issueq
  const Cluster clusters[MAX_CLUSTERS] = {
    {"all",  8, (FU_ALU0|FU_ALU1|FU_STU0|FU_STU1|FU_LDU0|FU_LDU1|FU_FPU0|FU_FPU1)},
   };
