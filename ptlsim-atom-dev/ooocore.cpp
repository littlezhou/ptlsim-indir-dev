...
ostream& OutOfOrderCoreEvent::print(ostream& os) const {
  ...
  case EVENT_FRONTEND:
    ...
    break;
  case EVENT_NONBLOCKING_DISPATCH_STALL:
     os << "nonblocking-dispatch-stall rob ", intstring(rob, -3), "(",padstring(uopname,-5),")", " rip: 0x", hexstring(rip.rip, 24), " nonblocking: ", nonblocking;
  break;
  ...
  break;
  case  EVENT_FOUND_NONBLOCKING_ANCESTOR_DESC:
     os << "found-nonblocking-ancestor-desc  rob ", intstring(rob, -3), "(",padstring(uopname,-5),")", " rip: 0x", hexstring(rip.rip, 24), " nonblocking: ", nonblocking;
  break;
  ...
  case EVENT_DISPATCH_OK: {
    os << ((type == EVENT_DISPATCH_OK) ? "disptc" : "nodisp"),  " rob ", intstring(rob, -3), "(",padstring(uopname,-5),")", " nonblocking: ", nonblocking , " operands "; 
